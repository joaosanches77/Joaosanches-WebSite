...
<a id="back-to-top" href="#"
  class="fixed bottom-8 right-8 z-50 w-8 h-8 md:w-14 md:h-14 rounded-full bg-[#FF4500] text-white flex items-center justify-center shadow-lg transition-all duration-500 opacity-0 invisible hover:-translate-y-2 hover:shadow-xl group">
