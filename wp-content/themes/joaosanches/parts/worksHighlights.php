...
<section id="works" class=" pt-16 sm:pt-20 pb-24 sm:pb-40 relative">
            ...
            <div class="owl-carousel product-carousel owl-theme">
                ...
                if ($products_query->have_posts()):
                    while ($products_query->have_posts()):
                        ...
                        <div class="item flex flex-col h-full rounded-3xl shadow-sm mb-1 border border-grey-dark">
                            ...
                            <div class="flex-grow flex flex-col p-5">
                                ...
                                <div class="mt-6 flex justify-between items-center">
                                    ...
                                    <div class="text-right">
                                        <a
                                            class="carousel-prev-btn p-2 rounded-full w-full flex items-center justify-center gap-3 px-2 py-2 text-16px font-medium text-green-01 bg-green-04/10 hover:bg-green-04/30 js-transition border border-white">
