...
function language_selector()
{
    if (function_exists("icl_get_languages")):
        ...
        if (!empty($languages) && count($languages) > 1):
            ...
            echo "<button type='button' data-dropdown-toggle='languages' class='p-2 rounded-full inline-flex items-center font-medium gap-2 text-xl text-green-01 bg-beje-02 hover:bg-green-04/40 js-transition'>";
